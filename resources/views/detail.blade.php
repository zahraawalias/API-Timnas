...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Detail Apps</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Detail Apps</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between mt-3">
                                <h5 class="w-50">Detail Apps</h5>
                                <div class="d-flex justify-content-end w-50">
                                    <button href="{{ route('verify') }}" type="button" class="btn btn-primary">Back
                                        List</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <form>
                                        <div class="form-group">
                                            <label class="form-label">Tittle Apps</label>
                                            <input type="text" class="form-control" placeholder="Text">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="exampleFormControlSelect1">Select Users
                                                PIC</label>
                                            <select class="form-select" id="exampleFormControlSelect1">
                                                <option value="">Select PIC</option>
                                                <!-- Data PIC dari master data -->
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="exampleFormControlSelect1">Select Network
                                                Area</label>
                                            <select class="form-select" id="exampleFormControlSelect1">
                                ...
                                <div class="form-group">
                                    <label for="validationTextarea" class="form-label">Desc Your Apps</label>
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <button data-pc-animate="fade-in-scale" type="button" data-bs-toggle="modal"
                                            data-bs-target="#animateModal1"
                                            class="btn btn-outline-secondary w-50 me-2 rounded-2">Return Apps</button>
                                        <button type="button" class="btn btn-outline-primary w-50 rounded-2"
                                            data-pc-animate="fade-in-scale" type="button" data-bs-toggle="modal"
                                            data-bs-target="#animateModal2">Approve Apps</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Return Apps</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label class="form-label">Note For Return *</label>
                            <textarea type="text" class="form-control text-center pt-5" rows="5"></textarea>
                        </div>
                        <div class="d-flex mt-5">
                            <button type="button" class="btn btn-outline-primary w-50 float-end rounded-2"><a
                                    href="{{ route('dashboard') }}">Submit</a></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade modal-animate" id="animateModal2" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Approve Apps</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <textarea type="text" class="form-control text-center pt-5" placeholder="E-Sign Approval" rows="5"></textarea>
                        </div>
                        <div class="d-flex mt-5">
                            <button type="button" class="btn btn-outline-primary w-50 float-end rounded-2"><a
                                    href="{{ route('dashboard') }}">Submit</a></button>
    ...
    <script>
        document.getElementById('imageUpload').addEventListener('change', function(event) {
            const file = event.target.files[0]; // Mengambil file yang di-upload

            // Validasi file (PNG, JPG, JPEG)
            ...
            if (file && validImageTypes.includes(file.type)) {
                ...
                reader.onload = function(e) {
                    ...
                    previewDiv.innerHTML =
                        `<img src="${e.target.result}" alt="Preview Image" style="max-width: 100%; height: auto;">`;
                };
        ...
        // Fetch data untuk Users PIC dari master data (contoh menggunakan JavaScript fetch)
        fetch('/api/master-pic') // Ubah endpoint ini sesuai dengan data master yang kamu miliki
            .then(response => response.json())
            .then(data => {
                const usersPICSelect = document.getElementById('usersPIC');
                data.forEach(pic => {
                    const option = document.createElement('option');
                    option.value = pic.id;
                    option.textContent = pic.name;
                    usersPICSelect.appendChild(option);
                });
            })
            .catch(error => console.error('Error fetching PIC data:', error));
    </script>
