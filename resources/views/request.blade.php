                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Request Apps</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Request Apps</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between mt-3">
                                ...
                                <div class="d-flex justify-content-end w-50">
                                    <button id="add-new" type="button" class="btn btn-primary rounded-2">Add
                                        New</button>
                                </div>
                            </div>
                        </div>
                                ...
                                <table id="colum-render" class="table table-striped table-bordered nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Name Apps</th>
                                            <th>PIC Apps</th>
                                            <th>URL Last Updates</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="table-body">
                                        <!-- Kosong pada tampilan awal -->
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            <th>No.</th>
