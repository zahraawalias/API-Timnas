            ...
            <div class="auth-form">
                <div class="card my-5">
                    <div class="card-body shadow-lg">
                        <img src="https://www.kalbe.co.id/_next/static/media/Logo-Kalbe.0cf6623a.svg"
                            class="img-thumbnail" alt="...">
                        <h4 class="text-center f-w-500">Login Account</h4>
                        <h4 class="text-center f-w-500 mb-3">MSTD Dashboard Apps</h4>
                        <div class="saprator my-3"></div>
                        <div class="form-group mb-3">
                            <label for="exampleFormControlInput1" class="form-label">Email One Kalbe</label>
                        ...
                        <div class="d-grid mt-4">
                            <button type="button" class="btn btn-primary rounded-2">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn active" data-value="true"
                                        ...
                                        <img src="{{ asset('assets/images/customizer/img-caption-1.svg') }}"
                            ...
                            <div class="col-6">
                                <div class="d-grid">
                                    <button class="preset-btn btn" data-value="false"
                                        ...
                                        <img src="{{ asset('assets/images/customizer/img-caption-2.svg') }}"
                                            alt="img" class="img-fluid" width="70%" />
                                    </button>
                                </div>
                            </div>
