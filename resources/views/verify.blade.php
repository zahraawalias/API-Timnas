                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Verify Apps</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Verify Apps</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between mt-3">
                                <h5 class="w-50">Manage Verify Apps</h5>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="colum-render" class="table table-striped table-bordered nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Action</th> <!-- Kolom Action pindah ke bagian terakhir -->
                                        </tr>
                                    </thead>
                                    <tbody id="table-body">
