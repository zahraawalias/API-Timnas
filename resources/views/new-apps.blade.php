                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Add New Apps</li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h2 class="mb-0">Add New Apps</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between mt-3">
                                <h5 class="w-50">Add New Apps</h5>
                                <div class="d-flex justify-content-end w-50">
                                    <a href="#" class="btn btn-primary rounded-2">Back List</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            $('#summernote').summernote({
                ...
                placeholder: 'Describe Your Apps',
                tabsize: 2
            });
        });
    </script>
